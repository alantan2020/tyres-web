        ...
        mainEntity: [
          {
            ...
            acceptedAnswer: { '@type': 'Answer', text: 'The Honda Accord uses three main OEM tyre sizes depending on generation and trim: 225/50R17 (base/EX trims across all three generations), 235/45R18 (Gen 9 CR V6 trims and Gen 10 CV HEV Sport), and 235/40R19 (Gen 10 CV and Gen 11 CY Sport/EL top trims). All generations share the 5×114.3 bolt pattern with a 64.1mm centre bore.' },
          },
          {
            '@type': 'Question',
  ...
  <main class="container main-content">
      ...
      <div class="table-wrap">
        <table class="data-table">
          ...
          <tbody>
            ...
            <tr>
              <td class="row-label muted">2018–2024 · Gen 10 CV · 1.5 Turbo Base/EX</td>
              <td><span class="tag tag-oe">OE</span></td>
              <td class="mono-bold">225/50R17</td>
              <td class="price-cell">from $120</td>
            </tr>
            <tr>
              <td class="row-label">2018–2024 · Gen 10 CV · 2.0 HEV Sport</td>
              <td><span class="tag tag-oe">OE</span></td>
              <td class="mono-bold">235/45R18</td>
              <td class="price-cell">from $145</td>
            </tr>
            <tr>
              <td class="row-label muted">2018–2024 · Gen 10 CV · 2.0 HEV Base/EX</td>
              <td><span class="tag tag-oe">OE</span></td>
              <td class="mono-bold">225/50R17</td>
              <td class="price-cell">from $120</td>
            </tr>
    ...
    <section id="rims-spec" class="card">
      ...
      <div class="table-wrap">
        <table class="data-table">
          ...
          <tbody>
            ...
            <tr>
              <td class="row-label">2018–2024 · Gen 10 CV · HEV Sport (18")</td>
            ...
            <tr>
              <td class="row-label">2018–2024 · Gen 10 CV · Base/EX (17")</td>
              <td class="mono-bold">7.5J</td>
              <td class="mono-alt">17"</td>
              <td class="mono-alt">ET45</td>
              <td class="mono-bold" style="color: var(--red);">5×114.3</td>
      ...
      <div class="spec-pills-bar">
        ...
        <span class="pill-divider">·</span>
        <span><strong>Note:</strong> Gen 9 CR uses ET55; Gen 10/11 uses ET45–ET50 — verify before buying spacers</span>
      </div>
    </section>
    ...
    <section id="prices" class="card">
      ...
      <template v-else-if="activeTab === 'R18'">
        ...
        <div class="set-estimate">
          <strong>Full set of 4 tyres + installation:</strong>
          Budget $580–$660 · Mid-range $720–$860 · Premium $900–$1,080
        </div>
      </template>
      ...
      <template v-else>
        ...
        <div class="set-estimate">
          <strong>Full set of 4 tyres + installation:</strong>
          Budget $680–$760 · Mid-range $840–$1,000 · Premium $1,060–$1,260
        </div>
      </template>
    </section>
    ...
    <section id="faq" class="faq-section">
      ...
      <details class="faq-item" open>
        <summary>
          <h3>What tyre size does the Honda Accord use in Singapore?</h3>
          <span class="faq-chevron">▾</span>
        </summary>
        <div class="faq-body">
          <p>It depends on the generation and trim:</p>
          <ul>
            <li><strong>Gen 11 CY (2022–2026) Sport/EL:</strong> <strong>235/40R19</strong> (8.5J rim, ET50)</li>
            <li><strong>Gen 11 CY (2022–2026) Base:</strong> <strong>225/50R17</strong> (7.5J rim, ET45)</li>
            <li><strong>Gen 10 CV (2018–2024) 1.5T Sport/EL:</strong> <strong>235/40R19</strong></li>
            <li><strong>Gen 10 CV (2018–2024) 1.5T Base/EX:</strong> <strong>225/50R17</strong></li>
            <li><strong>Gen 10 CV (2018–2024) 2.0 HEV Sport:</strong> <strong>235/45R18</strong></li>
            <li><strong>Gen 9 CR (2013–2019) 3.5i / 3.0i / 2.0:</strong> <strong>235/45R18</strong></li>
            <li><strong>Gen 9 CR (2013–2019) 2.4i:</strong> <strong>225/50R17</strong></li>
          </ul>
          <p>All generations share the <strong>5×114.3 bolt pattern</strong> with a 64.1mm centre bore.</p>
        </div>
      </details>
      ...
      <details class="faq-item">
        <summary>
          <h3>How much does it cost to replace tyres on a Honda Accord in Singapore?</h3>
          <span class="faq-chevron">▾</span>
        </summary>
        <div class="faq-body">
          For <strong>225/50R17</strong>: budget from <strong>$120–$140</strong> installed; mid-range $155–$185; premium $190–$235.<br><br>
          For <strong>235/45R18</strong>: budget from <strong>$145</strong>; mid-range $180–$215; premium $225–$270.<br><br>
          For <strong>235/40R19</strong>: budget from <strong>$170</strong>; mid-range $210–$250; premium $265–$320.<br><br>
          A full set of 4 mid-range tyres for the 225/50R17 size typically costs <strong>$620–$740 all-in</strong>.
        </div>
      </details>

      <details class="faq-item">
        <summary>
          <h3>Can I use 225/50R17 tyres on a Honda Accord that originally came with 235/40R19?</h3>
          <span class="faq-chevron">▾</span>
        </summary>
        <div class="faq-body">
